(this["webpackJsonpcandy-machine-mint"] = this["webpackJsonpcandy-machine-mint"] || []).push([
    [0], {
        216: function(e, t, n) {
            "use strict";
            (function(e) {
                n.d(t, "a", (function() { return l })), n.d(t, "b", (function() { return b })), n.d(t, "c", (function() { return O }));
                var r = n(2),
                    a = n.n(r),
                    c = n(7),
                    i = n(38),
                    ...
                    l = function() {
                        var e = Object(c.a)(a.a.mark((function e(t, n, r) {
                            var i, s, o, u, l, d = arguments;
                            return a.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return i = d.length > 3 && void 0 !== d[3] ? d[3] : "recent", s = d.length > 4 && void 0 !== d[4] && d[4], o = !1, u = { slot: 0, confirmations: 0, err: null }, l = 0, e.next = 7, new Promise(function() {
                                            var e = Object(c.a)(a.a.mark((function e(d, b) {
                                                return a.a.wrap((function(e) {
                                                    for (;;) switch (e.prev = e.next) {
                                                        case 0:
                                                            setTimeout((function() { o || (o = !0, console.log("Rejecting for timeout..."), b({ timeout: !0 })) }), n);
                                                            try { l = r.onSignature(t, (function(e, t) { o = !0, u = { err: e.err, slot: t.slot, confirmations: 0 }, e.err ? (console.log("Rejected via websocket", e.err), b(u)) : (console.log("Resolved via websocket", e), d(u)) }), i) } catch (f) { o = !0, console.error("WS error in setup", t, f) }
                                                        case 2:
                                                            if (o || !s) { e.next = 8; break }
                                                            return Object(c.a)(a.a.mark((function e() {
                                                                ...
                                                                return a.a.wrap((function(e) {
                                                                    for (;;) switch (e.prev = e.next) {
                                                                        ...
                                                                        case 3:
                                                                            n = e.sent, u = n && n.value[0], o || (u ? u.err ? (console.log("REST error for", t, u), o = !0, b(u.err)) : u.confirmations ? (console.log("REST confirmation for", t, u), o = !0, d(u)) : console.log("REST no confirmations for", t, u) : console.log("REST null result for", t, u)), e.next = 11;
                                                                            break;
                                                                        case 8:
                    ...
                    f = function() {
                        var t = Object(c.a)(a.a.mark((function t(n, r, c) {
            ...
            var r, a, c, i, s = n(0),
                ...
                L = function(e) {
                    ...
                    var t = e.hours,
                        ...
                        r = e.seconds;
                    e.completed;
                    return Object(M.jsxs)(W, { children: [t < 10 ? "0" + t : t, ":", n < 10 ? "0" + n : n, ":", r < 10 ? "0" + r : r] })
                },
                D = function(e) {
                    var t = Object(s.useState)(!0),
                        ...
                        ue = se[1],
                        le = function() {
                            var t = Object(p.a)(f.a.mark((function t() {
                                var n, r, a, c, i;
                                return f.a.wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            if (D(!0), n = void 0, t.prev = 2, !(ce.connected && (null === oe || void 0 === oe ? void 0 : oe.program) && ce.publicKey)) { t.next = 16; break }
                                            return t.next = 6, Object(P.c)(oe, e.config, ce.publicKey, e.treasury);
                                        case 6:
                        ...
                        de = function() {
                            var t = Object(p.a)(f.a.mark((function t() {
                                ...
                                return f.a.wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            if (a(!0), ce && ce.publicKey && ce.signAllTransactions && ce.signTransaction) { t.next = 4; break }
                                            return a(!1), t.abrupt("return");
                                        case 4:
                ...
                Y = function() {
                    var e = Object(s.useMemo)((function() { return N }), []),
                        t = Object(s.useMemo)((function() { return [Object(E.getPhantomWallet)(), Object(E.getSolflareWallet)(), Object(E.getSolletWallet)()] }), []);
                    return Object(M.jsx)(k.ConnectionProvider, { endpoint: e, children: Object(M.jsx)(k.WalletProvider, { wallets: t, autoConnect: !0, children: Object(M.jsx)(S.WalletDialogProvider, { featuredWallets: 5, children: Object(M.jsx)(D, { candyMachineId: C, config: B, network: "mainnet", connection: U, startDate: _, treasury: I, txTimeout: 6e4 }) }) }) })
                };
